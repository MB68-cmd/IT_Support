...
{
    /// <summary>
    /// Die Hauptklasse, die das Spiel startet und die Hauptschleife enthält. Hier wird die Welt initialisiert, die Eingaben verarbeitet und der Spielfluss gesteuert.
    /// </summary>
...
");
            ...
            while (spielLaeuft)
            {
                ...
                UI.ZeichneMenue(aktuellerRaum.Ausgaenge, aktuellerRaum.GegenstaendeImRaum, spieler);        // Zeigt die möglichen Bewegungen und Gegenstände im Raum an
